...
export default function MarketingTools() {
    ...
    const materials = useMemo(() => ([
        ...
        // Real Estate Addons
        { iconClass: 'addon', icon: '🗓️', title: 'Client Milestone Timeline', path: '/realestate/marketing-tools/addons/client-milestone-automation', meta: 'Interactive Tool', tags: ['timeline', 'client follow-up'], category: 'Power Plan', description: 'Generate personalized post-closing touchpoints with ready-to-send messages.', requiresAddon: true, addonKey: 'client-milestone-automation' },
        { iconClass: 'addon', icon: '🧮', title: 'Commission Calculator MVP', path: '/realestate/marketing-tools/addons/advanced-commission-calculator', meta: 'Interactive Tool', tags: ['commission', 'forecasting'], category: 'Power Plan', description: 'Calculate complex commission scenarios with split, referral, and forecasting insights.', requiresAddon: true, addonKey: 'advanced-commission-calculator' },
        ...
        { iconClass: 'addon', icon: '📊', title: 'Probate Market Tracker', path: '/realestate/marketing-tools/addons/probate-market-analyzer', meta: 'Interactive Tool', tags: ['probate', 'market', 'tracking'], category: 'Power Plan', description: 'Track probate properties and market opportunities in your area.', requiresAddon: true, addonKey: 'probate-market-analyzer' },
